...
public class QueryConstants {
	...
	public static final String GET_ACCOUNT_BY_ID = "SELECT id_account, name, surname, status, photo FROM account WHERE id_account = ?;";
	public static final String INSERT_ACCOUNT = "INSERT INTO account(id_account, name, surname, status, photo, login, password) VALUES(?, ?, ?, ?::account_status, ?, ?, ?);";
	...
	public static final String INSERT_CATEGORY = "INSERT INTO category(id_category, name, description, image) VALUES (?, ?, ?, ?);";
	public static final String DELETE_CATEGORY_BY_ID = "DELETE FROM category WHERE id_category = ?;";
	public static final String GET_CATEGORY_BY_ID = "SELECT id_category, name, description, image FROM category WHERE id_category = ?;";
	...
	public static final String INSERT_MESSAGE = "INSERT INTO message(id_message, name, text, id_category, id_author, date_of_posting) VALUES (?, ?, ?, ?, ?, ?);";
	public static final String DELETE_MESSAGE_BY_ID = "DELETE FROM message WHERE id_message = ?;";
	public static final String GET_MESSAGE_BY_ID = "SELECT id_message, name, text, id_author, date_of_posting FROM message WHERE id_message = ?;";
	...
	public static final String INSERT_ANSWER = "INSERT INTO answer(id_answer, id_message, text, date_of_posting, id_author) VALUES (?, ?, ?, ?, ?);";
	public static final String DELETE_ANSWER_BY_ID = "DELETE FROM answer WHERE id_answer = ?;";
	public static final String GET_ANSWER_BY_ID = "SELECT id_answer, text, date_of_posting, id_author FROM answer WHERE id_answer = ?;";
	...
	public static final String INSERT_IMAGE = "INSERT INTO image(id_image, path, format) VALUES (?, ?, ?);";
	public static final String DELETE_IMAGE_BY_ID = "DELETE FROM image WHERE id_image = ?;";
	public static final String GET_IMAGE_BY_ID = "SELECT id_image, path, format FROM image WHERE id_image = ?;";
