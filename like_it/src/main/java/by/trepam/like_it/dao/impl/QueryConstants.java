...
public class QueryConstants {
	...
	public static final String GET_ACCOUNT_BY_ID = "SELECT login, name, surname, status, photo FROM account WHERE id_account = ?;";
	...
	public static final String FIND_LOGIN = "SELECT * FROM account WHERE login = ?;";

	public static final String INSERT_CATEGORY = "INSERT INTO category(name, description, image) VALUES (?, ?, ?);";
	public static final String DELETE_CATEGORY_BY_ID = "DELETE FROM category_text WHERE id_category = ?;DELETE FROM category WHERE id_category = ?;";
	public static final String GET_CATEGORY_BY_ID = "SELECT g.image, coalesce(t.name, g.name) AS name, coalesce(t.description, g.description) AS description FROM category AS g LEFT JOIN (SELECT * FROM category_text WHERE lang = ?) AS t USING(id_category) WHERE g.id_category=?;";
	public static final String UPDATE_CATEGORY = "UPDATE category SET name = ?, description = ?, image = ? WHERE id_category = ?;";
	public static final String GET_ALL_CATEGORIES = "SELECT g.id_category, g.image, coalesce(t.name, g.name) AS fname, coalesce(t.description, g.description) AS description FROM category AS g LEFT JOIN (SELECT * FROM category_text WHERE lang = ?) AS t USING(id_category);";
	public static final String INSERT_CATEGORY_TEXT = "INSERT INTO category_text(lang, name, description, id_category) VALUES(?, ?, ?, ?);";
	public static final String GET_CATEGORY_ID_BY_NAME = "SELECT id_category FROM category WHERE name = ?;";
	public static final String UPDATE_CATEGORY_TEXT = "UPDATE category_text SET name = ?, description = ? WHERE id_category = ? AND lang = ?;";
	public static final String DELETE_CATEGORY_TEXT = "DELETE FROM category WHERE id_category = ? AND lang = ?;";
	...
	public static final String UPDATE_MESSAGE = "UPDATE message SET name = ?, text = ? WHERE id_message = ?;";
