...
<head>
		...
		<fmt:message bundle="${loc}" key="local.main_text.question.1" var="question1" />
		<fmt:message bundle="${loc}" key="local.main_text.answer.1" var="answer1" />
		<fmt:message bundle="${loc}" key="local.main_text.question.2" var="question2" />
		<fmt:message bundle="${loc}" key="local.main_text.answer.2" var="answer2" />
		<fmt:message bundle="${loc}" key="local.main_text.question.3" var="question3" />
		...
		<fmt:message bundle="${loc}" key="local.button.add_account" var="add_account" />
	</head>
	<body>
		<header>    
		...
		<section class="col-6 col-m-9 main_text">
			...
			<h4><c:out value="${question1}" /></h4>
			<p><c:out value="${answer1}" /></p>
			<h4><c:out value="${question2}" /></h4>
			<p><c:out value="${answer2}" /></p>
			<h4><c:out value="${question3}" /></h4>
			<a href="../like_it/registration" class="link"><c:out value="${answer3}" /></a>				
		</section>
		<aside class="col-3 col-m-12">	
			<ul class="menu">
				...
				<li>				
					<c:if test ="${sessionScope.status == 'admin'}">						
						<a href="../like_it/registration" class="small_button menu_item"><c:out value="${add_account}" /></a>						
					</c:if>
				</li>
			</ul>						
		</aside>
