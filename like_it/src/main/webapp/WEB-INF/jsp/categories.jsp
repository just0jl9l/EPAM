...
<fmt:message bundle="${loc}" key="local.button.add_category"
	var="add_category" />
</head>
<body>
	...
	<div class="categories_menu">
		<c:forEach var="item" items="${sessionScope.categories}">
			<a
				...
				class="category"> <img src="${item.image.path}"
	...
	<ul class="menu">
		...
		<li><c:if test="${sessionScope.status == 'admin'}">
				<a href="../like-it/add-category" class="small_button menu_item"><c:out
						value="${add_category}" /></a>
			</c:if></li>
	</ul>
	</aside>
</body>
