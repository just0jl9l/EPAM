...
<body>
	...
	<ul class="menu">
		<li>
			<h1 class="h1">
				<a href="../like-it" class="sitemap_item line"><c:out
						value="${main_page}" /></a>
			</h1>
			<ul class="menu">
				<li>
					<h2 class="h2">
						<a href="../like-it/Controller?command=categories"
							class="sitemap_item line"><c:out value="${categories}" /></a>
					</h2>
					<ul class="menu">
						<c:forEach var="item" items="${sessionScope.categories}">
							<li>
								<h3 class="h3">
									<a
										href="../like-it/Controller?category-id=${item.id}&command=category"
										class="category"> <c:out value="${item.name}" />
									</a>
								</h3>
							</li>
						</c:forEach>
				...
				<li>
					<h2 class="h2">
						<a href="../like-it/Controller?command=personal-account"
							class="sitemap_item line"><c:out value="${personal_account}" /></a>
					</h2>
				</li>
			</ul>
		</li>
