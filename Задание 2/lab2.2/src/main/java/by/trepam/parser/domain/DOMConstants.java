...
public class DOMConstants {
	public static final String BEGINING_OF_XML_DECLARATION = "<?";
	public static final String ENDING_OF_XML_DECLARATION = "?>";
	...
	public static final String CLOSING_END_OF_XML_TAG = "/>";
