...
<body>
	...
	<form class="center" action="Controller" method="post">
		...
		<figure class="col-4 col-m-12 category_photo"> <c:if
			...
			<p>
				<img src="${sessionScope.category.image.path}"
					alt="изображение категории" class="big_photo">
			</p>
		</c:if> <input value="${add}" type="file" name="image"> </figure>
		<div class="col-6 col-m-12">
			<c:if test="${sessionScope.notAllDataError == 'true'}">
