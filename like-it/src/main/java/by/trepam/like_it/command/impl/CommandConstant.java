...
public class CommandConstant {
	...
	public static final String PARAM_SECOND_PASSWORD = "password2";
	public static final String PARAM_PASSWORD_ERROR = "passwordError";
	public static final String PARAM_NOT_ALL_DATA_ERROR = "notAllDataError";
	...
	public static final String PARAM_CATEGORY_EN = "categoryEn";
	public static final String PARAM_CATEGORY_RU = "categoryRu";
	public static final String PARAM_CATEGORIES = "categories";
	public static final String PARAM_IMAGE = "image";
	public static final String PARAM_TITLE = "title";
	public static final String PARAM_TITLE_RU = "titleRu";
	public static final String PARAM_TITLE_EN = "titleEn";
	public static final String PARAM_DESCRIPTION_RU = "descriptionRu";
	public static final String PARAM_DESCRIPTION_EN = "descriptionEn";
}
